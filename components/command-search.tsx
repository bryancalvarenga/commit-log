  ...
  return (
    <>
      ...
      >
        ...
        <span>Buscar...</span>
        <kbd className="ml-2 rounded border bg-background px-1.5 py-0.5 font-mono text-[10px] text-muted-foreground">/</kbd>
      </button>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-start justify-center pt-[15vh]">
          ...
          />
          <div className="relative z-50 w-full max-w-lg rounded-xl border bg-card shadow-2xl" role="dialog" aria-label="Buscar posts">
            ...
            {query.trim() && (
              <div className="max-h-72 overflow-y-auto p-2">
                {results.length > 0 ? (
                  <ul role="listbox">
                    {results.map((post, i) => (
                      <li key={post.id} role="option" aria-selected={i === selectedIndex}>
                        <button
                  ...
                  <div className="py-8 text-center">
                    ...
                    <p className="mt-1 text-xs text-muted-foreground">Tente buscar com outros termos.</p>
                  </div>
                )}
              </div>
            )}
